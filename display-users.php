...
<?php 
  include('authentication.php');
    echo "<h5>"."Welcome Admin! Displaying users."."</h5>";
    $contacts = file("users.txt",FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES) or die("Unable to open file!");
