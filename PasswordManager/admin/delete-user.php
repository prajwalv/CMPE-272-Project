...
for($i=0;$i<$delete_count;$i++)
{
   ...
   $delete_query2= mysqli_query($conn,"Delete from general where uid='$deleting_id'");
   $delete_query3 = mysqli_query($conn,"Delete from bank where uid='$deleting_id'");
   $delete_query1= mysqli_query($conn,"Delete from users where uid='$deleting_id'");
   echo "<script type='text/javascript'>window.location.href = '/PasswordManager/admin/delete-user.php';</script>";
}
mysqli_close($conn);
}
}
