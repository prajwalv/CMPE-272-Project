  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="mt-4"></h1>          
<p style="text-align:left;font-size:50px";><strong>Welcome User</p>
<p style="text-align:left;font-size:35px";><a class="nav-link" href="user-create.php">1. Create User</a></p>
<p style="text-align:left;font-size:35px";><a class="nav-link" href="user-search.php">2. Search User</a></p>
